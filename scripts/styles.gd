...
var styles: Dictionary = {
	...
	"castle_keep": {
		...
		"decor": [
			...
			{"model": "wooden_candlestick", "pos": Vector3(2.55, 0.35, 2.5), "light": Vector3(0, 0.3, 0), "energy": 0.45, "range": 2.5},
			{"model": "brass_candleholders", "pos": Vector3(0.72, 0.42, -0.18), "scale": 0.45, "light": Vector3(0, 0.45, 0), "energy": 0.6, "range": 3.0},
